...
const material = new THREE.MeshPhongMaterial({
    map: new THREE.TextureLoader().load('/src/img/8k-earth-nightmap.jpg'),
    normalMap: new THREE.TextureLoader().load('/src/img/8k-earth-normal-map.tif'),
    specularMap: new THREE.TextureLoader().load('/src/img/8k-earth-specular-map.tif'),
...
const cloudMaterial = new THREE.MeshPhongMaterial({
    map: new THREE.TextureLoader().load('/src/img/8k-earth-clouds.jpg'),
    transparent: true,
    opacity: 0.5,
    depthWrite: false,
